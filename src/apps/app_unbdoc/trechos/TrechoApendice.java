...
public class TrechoApendice {
    public static TextoDocumento init(UnBDoc doc, Entidade raiz, Entidade pai, RefString documento, RefInt index, RefInt tamanho, PastaFS pastaEntrada, PastaFS pastaSaida, RefInt capituloID) {
        ...
        Entidade obj = ENTT.CRIAR_EM(pai.getEntidades(), "Nome", "!Apendice");
        ...
        FS.organizar_pasta(pastaSaida.getPasta("outros/apendices"));
        ...
        Texto.arquivo_escrever(pastaSaida.getArquivo("outros/apendices/apendice_" + capituloID.get() + ".tex"), Strings.ELIMINAR_LINHAS_VAZIAS(conteudo));
        ...
        docSaida.adicionarLinha("\\apendice{outros/apendices/apendice_" + capituloID.get() + "}{" + nomeCapitulo + "}");
        capituloID.somar(1);
