...
public class ComandoTitulo {
    public static TextoDocumento init(UnBDoc doc, Entidade raiz, Entidade pai, RefString documento, RefInt index, RefInt tamanho, PastaFS pastaEntrada, PastaFS pastaSaida, RefInt capituloID) {
        ...
        Entidade obj = ENTT.CRIAR_EM(pai.getEntidades(), "Nome", "@TITULO");
        ...
        docSaida.adicionarLinha("\\titulo{" + doc2.toDocumento() + "}");

        System.out.println("TITULO >> DEPOIS :: "+docSaida.toDocumento());
